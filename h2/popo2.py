...
MAX_EPISODE_STEPS = 2000  # Increase the number of steps per episode
...
def compute_reward(state, action, next_state, done):
    ...
    reward = forward_velocity * 2.0  # Increase the incentive for moving forward
...
old_checkpoint_path = '/home/uankit/checkpoints/sac_checkpoint.pth'  # Path to the old checkpoint
new_checkpoint_path = '/home/uankit/checkpoints/sac_checkpoint2.pth'  # Path to save the new checkpoint

# Load checkpoint if exists
try:
    agent.load_checkpoint(old_checkpoint_path)
    print("Checkpoint loaded successfully from", old_checkpoint_path)
...
for episode in range(num_episodes):
    ...
    agent.save_checkpoint(new_checkpoint_path)
