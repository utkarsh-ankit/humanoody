...
MAX_EPISODE_STEPS = 3000  # Increase the number of steps per episode
...
new_checkpoint_path = '/home/uankit/checkpoints/3/sac_checkpoint3.pth'  # Path to save the new checkpoint
